...
import { createCollectionTool, listCollectionsTool, getCollectionTool, addToCollectionTool, removeFromCollectionTool, updateCollectionTool, deleteCollectionTool, consolidateCollectionTool } from './collections.js';
...
import { skillScheduleTool, skillScheduleListTool, skillScheduleCancelTool, skillScheduleRetriggerTool, skillTasksPendingTool, skillTaskRetriggerTool, skillTasksListTool } from './skill_schedule.js';
// Category router
...
function buildFlatTools(clients) {
    return {
        // ChatGPT OAuth required tools
...
function buildGroupedTools(clients) {
 ...
 */
export function setupTools(clients) {
