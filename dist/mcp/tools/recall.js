...
export function recallTool(clients) {
    return {
        name: 'recall',
        description: 'Search and retrieve memories. Supports keyword/semantic/hybrid modes, tag/time/importance filters. Query is optional for filters-only searches.',
        inputSchema: {
            type: 'object',
            properties: {
                query: {
