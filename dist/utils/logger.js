 ...
 * redactSecrets.
 */
function redactErrorIfNeeded(value) {
...
const redactFormat = winston.format((info) => {
    ...
    for (const key of Object.keys(info)) {
        ...
        info[key] = redactErrorIfNeeded(info[key]);
    }
    return info;
});
...
export const logger = winston.createLogger({
    level: logLevel,
    format: winston.format.combine(winston.format.timestamp(), winston.format.errors({ stack: true }), redactFormat(), winston.format.json()),
